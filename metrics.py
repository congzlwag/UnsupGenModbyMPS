...
def plot_bas_synergy(data):
    """
    make a 6x5 grid plot showing different possibilties in the BAS dataset

    Args:
        data (np.ndarray): (22, 4, 3) np.int32 array containing the possible
            patterns in the BAS dataset
    ...
    assert data.shape == (22, 4, 3), f'data should have dimensions (22, 4, 3) \
        , given data has dimensions {data.shape}'
...
def plot_top_samples_synergy(samples):
    """
    ...
    fig, ax = plot_bas_synergy(top_samples)
    return fig, ax
